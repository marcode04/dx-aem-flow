...
description: "KAI is an enterprise AI development platform. Full agentic workflow from ticket to implementation with governance, testing, verification, and live AEM data. 75+ skills across Claude Code, Copilot CLI, and VS Code Chat."
---
...
<PageHero
  title="Enterprise AI Development Platform"
  subtitle={`Full agentic workflow from ticket to production — requirements, planning, implementation, testing, verification, and PR — fully autonomous. ${stats.totalSkills}+ skills across Claude Code, GitHub Copilot CLI, and VS Code Chat. Integrates with Azure DevOps, Jira, Figma, and live AEM data.`}
/>
