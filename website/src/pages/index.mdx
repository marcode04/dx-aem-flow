...
description: "KAI is an enterprise AI development platform. Full agentic workflow from ticket to implementation with governance, testing, verification, and live AEM data. 75+ skills across 10 AI platforms including Claude Code, Copilot CLI, VS Code Chat, Codex, Cursor, and Windsurf."
---
...
<PageHero
  title="Enterprise AI Development Platform"
  subtitle={`Full agentic workflow from ticket to production — requirements, planning, implementation, testing, verification, and PR — fully autonomous. ${stats.totalSkills}+ skills across ${stats.aiPlatforms} AI platforms — Claude Code, Copilot CLI, VS Code Chat, Codex, Cursor, Windsurf, and more. Integrates with Azure DevOps, Jira, Figma, and live AEM data.`}
/>

<Section>
  <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 text-center">
    <div>
      <div class="text-4xl font-extrabold text-cyan">{stats.totalSkills}</div>
      <div class="text-sm text-gray-500">Skills</div>
    </div>
    <div>
      <div class="text-4xl font-extrabold text-cyan">{stats.copilotAgents}</div>
      <div class="text-sm text-gray-500">Copilot Agents</div>
    </div>
    <div>
      <div class="text-4xl font-extrabold text-cyan">{stats.totalPlugins}</div>
      <div class="text-sm text-gray-500">Plugins</div>
    </div>
    <div>
      <div class="text-4xl font-extrabold text-cyan">{stats.aiPlatforms}</div>
      <div class="text-sm text-gray-500">AI Platforms*</div>
    </div>
    <div>
      <div class="text-4xl font-extrabold text-cyan">{stats.claudeAgents}</div>
...
<Section>
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
    ...
    <ContentCard icon="mdi:hammer-wrench" iconColor="bg-emerald-600" title="Every AI Platform" horizontal>
      Same {stats.totalSkills} skills work across {stats.aiPlatforms} AI platforms — Claude Code, Copilot CLI, VS Code Chat, Codex, Cursor, Windsurf, and more. Install once, use everywhere.
    </ContentCard>
  ...
  <div class="grid md:grid-cols-2 gap-4">
    <a href={`${base}/setup/`} class="no-underline">
      <ContentCard icon="mdi:cog" iconColor="bg-emerald-600" title="Set Up Your Project" horizontal>
        Install plugins, prepare seed data, run init. Three steps, works across {stats.aiPlatforms} AI platforms.
      </ContentCard>
    </a>
...
<SectionHeading
  ...
  subtitle={`Core workflow for any stack. AEM specialization for teams that need it — ${stats.dxAemSkills} skills and ${stats.dxAemAgents} agents covering the full AEM development lifecycle.`}
  bg="primary"
/>
<Section>
  <div class="grid md:grid-cols-3 gap-4">
...
<p class="text-xs text-gray-400 text-center mt-2 mb-4">*Fully tested with Claude Code, Copilot CLI, and VS Code Chat. Built on open standards (OpenSkills, OpenPlugins, AGENTS.md, MCP) so all compatible platforms work out of the box. Some agents that haven't fully adopted these standards yet are supported with platform-specific tweaks.</p>
