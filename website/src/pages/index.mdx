...
<Section>
  ...
  <p class="text-xs text-gray-400 text-center mt-3">*Fully tested with Claude Code, Copilot CLI, and VS Code Chat. All other platforms use the same open standards (AGENTS.md, .claude/rules/, MCP, .github/agents/) and are expected to work without changes.</p>
</Section>
