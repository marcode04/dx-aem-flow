...
<Section>
  ...
  <p class="text-center mt-4">
    <a href="/figma/" class="text-brand-700 font-semibold hover:text-cyan transition-colors">
...
<SectionHeading
  badge="Two Modes"
  badgeColor="secondary"
  title="Interactive & Autonomous"
  bg="alt"
/>
<Section>
  <div class="grid md:grid-cols-2 gap-4">
    <ContentCard icon="mdi:monitor" iconColor="bg-brand-700" title="Local / Interactive">
      Developer runs commands in their IDE. AI assists step by step. Full control, pause and review at any point.

      - Claude Code (`/dx-*` skills)
      - GitHub Copilot CLI (`@Agent` + `/dx-*` skills)
      - Files in `.ai/specs/`, commits, PRs
      - $100-200/month subscription
    </ContentCard>
    <ContentCard icon="mdi:lightning-bolt" iconColor="bg-red-500" title="Remote / Autonomous">
      Events trigger agents. No developer needed. Same skills, same quality -- running 24/7 on ADO pipelines.

      - Triggered by ADO webhooks (Jira planned)
      - AWS Lambda to ADO Pipeline
      - Rate-limited, budget-controlled
...
<Section>
  <div class="grid md:grid-cols-3 gap-4">
    <a href="/overview/" class="no-underline">
    ...
    <a href="/figma/" class="no-underline">
    ...
    <a href="/local-workflow/" class="no-underline">
    ...
    <a href="/bug-flow/" class="no-underline">
    ...
    <a href="/automation/" class="no-underline">
    ...
    <a href="/architecture/" class="no-underline">
    ...
    <a href="/costs/" class="no-underline">
    ...
    <a href="/demo-guide/" class="no-underline">
